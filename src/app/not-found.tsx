...
export const metadata: Metadata = {
  title: '404 — Page Not Found | GEM Services Pest Control',
  description: 'The page you are looking for does not exist. Contact GEM Services for fast pest control across Kent.',
}
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16 text-center">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <p className="text-xl text-neutral-muted leading-relaxed">
          ...
          If you are experiencing a pest emergency, please call us immediately.
        </p>
        ...
        <div className="pt-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <span className="text-neutral-300">&bull;</span>
            <Link href="/areas" className="text-brand-primary hover:underline font-medium">Areas We Cover</Link>
          </div>
        </div>
      </div>
    </div>
