...
export const ServiceHero = ({ title, subtitle, image, cta, service }: Props) => {
  return (
    <>
      <section className="relative min-h-[60vh] md:min-h-[65vh] flex items-center justify-center py-12 md:py-16 lg:py-20 text-center px-4 text-white overflow-hidden">
        <Image 
          src={image}
          alt={`${title} pest control service in Kent`}
          width={1200}
          height={700}
        ...
        <FadeIn className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="mb-8 overflow-hidden rounded-md max-w-xl mx-auto">
             <EmergencyBanner />
          </div>
          ...
          {cta ? (
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-full">
              <a 
                ...
                onClick={() => trackEvent('phone_click', { location: 'hero', service: service || 'unknown' })}
              ...
              <Link 
                href="/contact" 
                onClick={() => trackEvent('cta_click', { location: 'hero', action: 'quote', service: service || 'unknown' })}
