...
export const TownServiceHero = ({ title, subtitle, image, cta, town, service }: Props) => {
  return (
    <>
      <section className="relative min-h-[60vh] md:min-h-[65vh] flex items-center justify-center py-12 md:py-16 lg:py-20 text-center px-4 text-white overflow-hidden">
        ...
        <FadeIn className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="mb-8 overflow-hidden rounded-md max-w-xl mx-auto shadow-sm">
             <EmergencyBanner />
          </div>
          ...
          {cta ? (
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-full">
              <a 
                ...
                onClick={() => trackEvent('phone_click', { location: 'town_service_hero', town: town || 'unknown', service: service || 'unknown' })}
              ...
              <Link 
                href="/contact" 
                onClick={() => trackEvent('cta_click', { location: 'town_service_hero', action: 'quote', town: town || 'unknown', service: service || 'unknown' })}
